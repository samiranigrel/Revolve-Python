...
## Final Solution
1. Setup the python project with the venv, might get errors need to install the errord libraries manually with pip install
2. also comment out the errored libraries and install the other using pip install -r requirements.txt
3. Now activate the env and run python ./inputs_data_generator/main_data_generator.py
4. This will generate the input data in the outside folder, copy that into the assignment folder
5. Now run python python ./solution/solution_start.py
6. This will generate the required output.json with all the required data